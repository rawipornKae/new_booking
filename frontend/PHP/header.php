        ...
        <div class="topnav" id="myTopnav">
            ...
            <div class="dropdown">
                <button class="dropbtn bg profile">
                    <img src="../img/boy.png" class="img-user">
                    <?php echo $_SESSION["user"]; ?>
                </button>
                <div class="dropdown-content">
                    <a href="logout.php" class="txt">LOG OUT</a>
                </div>
            </div>
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="homepage.php" class="txt">Booking Car</a>
                    <a href="#" class="txt">Detail Booking</a>
                    <a href="#" class="txt">All Booking Record</a>
                </div>
            </div>
            ...
            <a href="bookingList.php">Booking Lists</a>
            <a href="bookingList.php" class="icons bookinglists">
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor"
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-content">
                    <a href="#" class="txt">Register User</a>
                    <a href="#" class="txt">Manage Account</a>
                    <a href="#" class="txt">Delete Booking</a>
                    <a href="#" class="txt">Register Car</a>
                    <a href="#" class="txt">Modify Car</a>
